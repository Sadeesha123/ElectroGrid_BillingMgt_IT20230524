...
public class BillsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = billObj.insertBill(request.getParameter("billName"), 
				 						   request.getParameter("billAddress"), 
				 						   request.getParameter("billUnits"),
				 						   request.getParameter("billUnitPrice"),
				 						   request.getParameter("billTotPrice"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
		 String output = billObj.updateBill(paras.get("hidBillIDSave").toString(), 
				 							...
				 							paras.get("billAddress").toString(),
				 							paras.get("billUnits").toString(),
				 							paras.get("billUnitPrice").toString(), 
				 							paras.get("billTotPrice").toString(), 
